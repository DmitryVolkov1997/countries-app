...
export const fetchDetails = createAsyncThunk<Country, string, { rejectValue: string }>(
...
export const fetchNeighbors = createAsyncThunk<Country[], string[], { rejectValue: string }>(
